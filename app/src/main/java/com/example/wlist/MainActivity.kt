...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var wListItem : MutableList<Wishlist>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        submitButton.setOnClickListener {
            wListItem.add(Wishlist(itemNameText.text.toString(),itemPriceText.text.toString().toDouble(),urlLocationText.text.toString().toUri()))
